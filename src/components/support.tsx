                ...
                md:max-w-2xl md:px-4 lg:max-w-4xl lg:px-12 text-center">
                    ...
                    text-n-1 ring-1 ring-inset ring-n-4">
                        <span className="text-md font-grotesk">
                            <img src={code} alt="code-icon" width={20}/>
                            </span>
                            ...
                            <dl className="max-w-xl space-y-8 text-base leading-7 text-n-3 lg:max-w-none">
                                ...
                                <div className="relative">
                                    <div className="flex items-center mb-5">
                                        ...
                                        <p className="text-n-3 tracking-wider ml-2">No steup required.
                                            Seamlessly integrate Nexus into your platform without the need for configuration.</p>
                                    </div>
                                </div>

                                {/** Second Coding Desc Here */}
                                <div className="relative">
                                    <div className="flex items-center mb-5">
                                        <div className="flex items-center justify-center p-3 bg-brand-purple rounded-xl">
                                            <img src={lines} alt="lines-icon" width={25} height={25} />
                                        </div>
                                        <p className="text-n-3 tracking-wider ml-2">Out-of-the-box Support. 
                                        Nexus provides extensive language support across various programming languages.</p>
                                    </div>
                                </div>

                                {/** Third Coding Desc Here */}
                                <div className="relative">
                                    <div className="flex items-center mb-5">
                                        <div className="flex items-center justify-center p-3 bg-brand-purple rounded-xl">
                                            <img src={lines} alt="lines-icon" width={25} height={25} />
                                        </div>
                                        <p className="text-n-3 tracking-wider ml-2">Cloud sync.
                                        Nexus ensures data consistency and accessibility across multiple devices.</p>
                                    </div>
                                </div>
